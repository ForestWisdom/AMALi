...
uarch = {
    ...
    # 其实L40S是Ada架构，不过在https://docs.nvidia.com/cuda/cuda-binary-utilities/index.html#nvidia-ampere-gpu-and-ada-instruction-set 中Ampere和Ada是共用同一套ISA的
    # 所以 L40S 也可以继续用 Tesla_Ampere
    "gpu_arch"           : "Tesla_Ampere",

    # A40 = sm_86
    "compute_capabilty"  : 89,

    # 核心频率：建议你用 nvidia-smi 实机读出来填（见下方第4节）
    # 先给一个占位值，不填会报错
    "clockspeed"         : 2520 * 10**6,
